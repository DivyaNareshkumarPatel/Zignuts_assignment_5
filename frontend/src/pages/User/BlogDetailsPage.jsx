...
const Icons = {
    ...
    Error: () => <svg className="w-16 h-16 text-gray-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
};
        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
                <div className="max-w-4xl mx-auto px-4 h-16 flex items-center">
                    <Link to="/" className="flex items-center text-gray-500 hover:text-green-600 font-medium transition-colors">
                        <Icons.Back />
                        Back to Articles
                    </Link>
                </div>
            ...
            <article>
                <header className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12 max-w-4xl mx-auto w-full">
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6 text-shadow-sm animate-fade-in-up delay-100">
                            {blog.title}
                        </h1>
                        <div className="flex flex-wrap items-center text-gray-300 text-sm md:text-base gap-6 animate-fade-in-up delay-200">
                ...
                <div className="max-w-3xl mx-auto px-5 py-12 md:py-20">
                    <div className="prose prose-lg md:prose-xl max-w-none text-gray-800 leading-relaxed font-serif">
                        <div 
                            className="whitespace-pre-wrap first-letter:text-5xl first-letter:font-bold first-letter:text-green-700 first-letter:mr-3 first-letter:float-left"
                        >
                            {blog.description}
                        </div>
                    </div>
                    <div className="mt-16 pt-8 border-t border-gray-100">
                        <p className="text-gray-500 italic text-center md:text-left">
                            Published in <span className="font-semibold text-gray-800">{blog.category?.name}</span>
                        </p>
                    </div>
